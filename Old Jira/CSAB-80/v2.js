		...
		switch (true) {
			case getUrl('Wings'):
				el.addEventListener('click', () => {
					(window.ph_analytics||[]).push( { event: "experiment_event", experiment_action: "click", experiment_variable: "Homepage Carousel - Wings" });
					ph.route('/menu/wings');
				});
				break;
			case getUrl('Melts'):
				el.addEventListener('click', () => {
					(window.ph_analytics||[]).push( { event: "experiment_event", experiment_action: "click", experiment_variable: "Homepage Carousel - Melts" });
					ph.route('/menu/melts');
				});
				break;
			case getUrl('Pasta'):
				el.addEventListener('click', () => {
					(window.ph_analytics||[]).push( { event: "experiment_event", experiment_action: "click", experiment_variable: "Homepage Carousel - Pasta" });
					ph.route('/menu/pasta');
				});
				break;
			case getUrl('Sides'):
				el.addEventListener('click', () => {
					(window.ph_analytics||[]).push( { event: "experiment_event", experiment_action: "click", experiment_variable: "Homepage Carousel - Sides" });
					ph.route('/menu/sides');
				});
				break;					
			case getUrl('Desserts'):
				el.addEventListener('click', () => {
					(window.ph_analytics||[]).push( { event: "experiment_event", experiment_action: "click", experiment_variable: "Homepage Carousel - Desserts" });
					ph.route('/menu/desserts');
				});
				break;
			case getUrl('Dips'):
				el.addEventListener('click', () => {
					(window.ph_analytics||[]).push( { event: "experiment_event", experiment_action: "click", experiment_variable: "Homepage Carousel - Dips" });
					ph.route('/menu/dips');
				});
				break;
			}
