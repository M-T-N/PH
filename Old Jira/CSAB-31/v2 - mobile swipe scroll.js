...
const runChanges = () => {
	...
	document.querySelectorAll('a[data-testid="link-nav-deals"], header > .MuiGrid-root > div[role="navigation"] ul#menu-list-grow li').forEach(el => {
		console.log(`FIRST LOG - ${el.title}`);
	});
	...
	function addLinks(){
		...
		// add navbar container and progression arrows
	...
	// // horizontal scroll click vfunction
  document.querySelectorAll('.navbar__arrow').forEach(el => {
	...
	// // horizontal scroll function for mobile
