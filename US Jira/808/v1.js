...
function init() {
	...
	console.log('[DEV - DARK] MXN3147 | CSAB-83 | Party of One Hmpg Banner -- V1');
  ...
  document.querySelector('#content div[role="presentation"]').insertAdjacentHTML('afterbegin', `
...
pollCallback(['#content div[role="presentation"]'], function() {
